...
一方で，ゲーム体験の質を大きく左右する要素として，「感動体験」が挙げられる．心理学者Daniel Kahneman@Kahneman は，人間は体験の良し悪しを「ピーク時の印象」と「終わり方」で判断する傾向があると述べている．ゲームにおいてもこの傾向は顕著であり，特にエンディング時の演出がゲーム全体の印象に大きな影響を与える．
...
このように，「ゲームの状況に応じて音楽を変える」手法はこれまでにも見られるが，「音楽に合わせてゲーム側を操作する」という逆転のアプローチは，あまり見られていない．そこで本研究では，BGMのクライマックスに合わせてラスボスが倒されるように，ラスボスの行動を制御するAIの構築を中心に，複数の手法を合わせた感動的なクライマックス演出の実現を目指す．
// これにより，ゲームのクライマックスにおける音楽とゲームプレイの一体感を高め，プレイヤーに強い感動を与える新しい演出手法を実現することを目指す．
...
単一のフレームワークのみでスキップや走行などの様々な二足歩行動作の効率的な学習を可能にしている。
...
現在のHP，攻撃力，防御力，ループまでの終了時間は正規化する．
