...
= 研究手法｜感情的展開の制御
次に，プレイヤーの状況に応じて，適切な展開を起こすことを考えます．
初めは，「会心の一撃でボスを倒す」「HPギリギリで耐える」などの感情を動かすイベントをいくつか設定します．
これらのイベントは，ボス戦中にランダムで発生させ，人間のプレイヤーに体験してもらいます．
その後，印象に残った場面とそのときの感情をアンケートで答えてもらい，同時に，選択したコマンドの内容や傾向，選択時間，待機中のボタン操作などのプレイログも合わせて記録します．
顔や脈拍などの生体情報を用いないのは，コスト面の理由だけでなく，実際のゲームへの応用可能性を考慮するためです．

こうして得たデータを使って，プレイヤーの感情に合ったイベントを選べるよう，ボスの行動を学習させます．最後に，その演出が印象に残ったかどうかを，演出なしの状態と比較してもらいます．

将来的には，シンデレラ曲線のような感情曲線に合わせて，感情を意図的に動かせるゲーム演出を目指しています．
