...
#let toc() = {
  align(left)[
    #text(font: "Hiragino Kaku Gothic ProN", size: 25pt, weight: "bold")[
      #v(-10pt)
      目次
      #v(10pt)
    ]
  ...
  locate(loc => {
    ...
    for el in elements {
      ...
      link(el.location())[#{
          ...
          if el.level == 1 {
            set text(font: "Hiragino Kaku Gothic ProN", weight: "black")
...
#let master_thesis(
  ...
  align(center)[
    ...
    #v(40pt)
    #text(font: "Hiragino Kaku Gothic ProN", weight: "bold", size: 20pt)[
      #title
    ]
    #v(50pt)
    ...
    #v(40pt)
    #text(font: "Hiragino Kaku Gothic ProN", weight: "bold", size: 19pt)[
      #author
    ]
    #pagebreak()
  ]
  ...
  show heading: it => (
    {
      set text(font: "Hiragino Kaku Gothic ProN", weight: "bold", size: 14pt)
      set block(above: 1.5em, below: 1.5em)
      it
    }
      + empty_par()
  ...
  set math.equation(supplement: [Eq.], numbering: equation_num)
